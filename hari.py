...
# #             for i in range(5):
# #                 cartoon_path = os.path.join(app.config['DOWNLOAD_FOLDER'], 'cartoon', f"cartoon_{i+1}_" + filename)
# #                 unique_url = generate_unique_url(cartoon_path)
# #                 responses.append(
# #                     {
# #                         "filename": f"cartoon_{i+1}_" + filename,
# #                         "download_link": unique_url
# #                     }
# #                 )
# #                 # Auto-download the file
# #                 download_path = os.path.abspath(cartoon_path)
...
# # @app.get("/images/{hash_value}")
# # async def get_image(hash_value: str):
# #     image_path = os.path.join(app.config['DOWNLOAD_FOLDER'], 'cartoon', hash_value)
...
#         # Create a unique URL using the hash value
#         unique_url = f"http://localhost:12000/images/{hash_value}"
#         return unique_url
...
# Modify the "toonify" route to return a shareable unique URL for each processed image
# @app.post("/toonify")
# async def toonify(files: List[UploadFile] = File(...)):
#     responses = []
#     for file in files:
#         if file and allowed_file(file.filename):
#             # Process the file and generate the share link
#             filename = secure_filename(file.filename)
#             file_path = os.path.join(app.config['UPLOAD_FOLDER'], filename)
#             with open(file_path, "wb") as buffer:
#                 buffer.write(await file.read())
...
#             for i in range(5):
#                 cartoon_path = os.path.join(app.config['DOWNLOAD_FOLDER'], 'cartoon', f"cartoon_{i+1}_" + filename)
#                 # Generate a shareable unique URL for the share link
#                 shareable_url = generate_shareable_url(cartoon_path)
#                 responses.append(
#                     {
#                         "filename": f"cartoon_{i+1}_" + filename,
#                         "share_link": shareable_url
#                     }
#                 )
#                 # Auto-download the file
#                 download_path = os.path.abspath(cartoon_path)
...
#             for i in range(5):
#                 cartoon_path = os.path.join(app.config['DOWNLOAD_FOLDER'], 'cartoon', f"cartoon_{i+1}_" + filename)
#                 # Generate a unique URL based on the cartoon path
#                 unique_url = hashlib.md5(cartoon_path.encode()).hexdigest()
#                 full_url = f"http://localhost:12000/download?path={unique_url}"
#                 responses.append(
#                     {
#                         "filename": f"cartoon_{i+1}_" + filename,
...
#             for i in range(5):
#                 cartoon_path = os.path.join(app.config['DOWNLOAD_FOLDER'], 'cartoon', f"cartoon_{i+1}_" + filename)
#                 # Generate a unique URL for the share link
#                 unique_url = generate_unique_url(cartoon_path)
#                 responses.append(
#                     {
#                         "filename": f"cartoon_{i+1}_" + filename,
#                         "share_link": f"/download?path={cartoon_path}",
...
#                 # Generate unique URL using hashlib
#                 share_link = f"https://localhost:12000/{hashlib.md5(cartoon_path.encode()).hexdigest()}"
